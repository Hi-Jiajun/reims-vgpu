...
///
/// Total over the values `crate::protocol::pixel_format` defines; every other
...
/// [`crate::protocol::pixel_format`] how to write a texel of it. Written as a
...
/// [`crate::protocol::pixel_format::SwizzlePlan::after`], because a
