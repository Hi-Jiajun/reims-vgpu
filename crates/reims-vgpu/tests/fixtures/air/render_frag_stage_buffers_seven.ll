; AIR fixture: a fragment stage that declares seven `[[buffer(k)]]` arguments,
; every one of them read (R9q).
;
; The second slot past the old ceiling: five and six are carried by the widened
; contract's own reviewed pair, seven is the first list whose length no reviewed
; arrangement states. See `render_frag_stage_buffers_five.ll` for what the
; family is and why every argument is summed into the attachment.
;
;   llvm-as render_frag_stage_buffers_seven.ll -o render_frag_stage_buffers_seven.air
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"
target triple = "air64_v28-apple-macosx26.5.0"

define <4 x float> @reims_stage_buffers_seven_frag(ptr addrspace(1) %b0, ptr addrspace(1) %b1, ptr addrspace(1) %b2, ptr addrspace(1) %b3, ptr addrspace(1) %b4, ptr addrspace(1) %b5, ptr addrspace(1) %b6) {
entry:
...
!air.fragment = !{!0}
!0 = !{ptr @reims_stage_buffers_seven_frag, !1, !2}
!1 = !{!3}
