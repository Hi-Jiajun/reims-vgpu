...
; (`research/docs/26` §14, R6): the *four*-stream corner of the class, one
; `float2` attribute per location 0..3, each arriving as its own vertex stream.
; Four is the canonical contract's `max_vertex_buffers`, so this module is the
; widest interface the class can state.
;
; Three offsets add into one shift, so no stream is decorative: the tests beside
...
;
;     llvm-as -o tests/fixtures/air/reims_indexed_tri_four_stream.air \
;             tests/fixtures/air/reims_indexed_tri_four_stream.ll
;
; The fragment half of the pair is the existing `render_frag.air` (entry
; `fmain`, `float4(0.25, 0.5, 0.75, 1)`).
source_filename = "reims_indexed_tri_four_stream.air"
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v16:16:16-v24:32:32-v32:32:32-v48:64:64-v64:64:64-v96:128:128-v128:128:128-v192:256:256-v256:256:256-v512:512:512-v1024:1024:1024-n8:16:32"
target triple = "air64_v28-apple-macosx26.5.0"

define <4 x float> @reims_four_stream_vertex(<2 x float> %pos, <2 x float> %a, <2 x float> %b, <2 x float> %c) local_unnamed_addr {
entry:
  %ab = fadd fast <2 x float> %a, %b
  %abc = fadd fast <2 x float> %ab, %c
  %shifted = fadd fast <2 x float> %pos, %abc
...
!13 = !{ptr @reims_four_stream_vertex, !14, !15}
!14 = !{!16}
!15 = !{!17, !18, !19, !20}
